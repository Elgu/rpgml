...
bool At::tick1( Type coord_type, int coord_dims )
{
  switch( coord_type.getEnum() )
  {
    case Type::BOOL  : return tick2< InType, bool     >( coord_dims );
    case Type::UINT8 : return tick2< InType, uint8_t  >( coord_dims );
    case Type::INT8  : return tick2< InType, int8_t   >( coord_dims );
    case Type::UINT16: return tick2< InType, uint16_t >( coord_dims );
    case Type::INT16 : return tick2< InType, int16_t  >( coord_dims );
    case Type::UINT32: return tick2< InType, uint32_t >( coord_dims );
    case Type::INT32 : return tick2< InType, int32_t  >( coord_dims );
    case Type::UINT64: return tick2< InType, uint64_t >( coord_dims );
    case Type::INT64 : return tick2< InType, int64_t  >( coord_dims );
    default:
...
bool At::tick2( int coord_dims )
{
  switch( coord_dims )
  {
    case 0: return tick3< InType, CoordType, 0 >();
    case 1: return tick3< InType, CoordType, 1 >();
    case 2: return tick3< InType, CoordType, 2 >();
    case 3: return tick3< InType, CoordType, 3 >();
    case 4: return tick3< InType, CoordType, 4 >();
    default:
      throw Exception()
...
bool At::tick3( void )
{
  GET_INPUT_ELEMENTS( INPUT_IN, in, InType );
...
bool At::tick( void )
{
  ...
  {
    case Type::BOOL    : return tick1< bool     >( coord_type, coord_dims );
    case Type::UINT8   : return tick1< uint8_t  >( coord_type, coord_dims );
    case Type::INT8    : return tick1< int8_t   >( coord_type, coord_dims );
    case Type::UINT16  : return tick1< uint16_t >( coord_type, coord_dims );
    case Type::INT16   : return tick1< int16_t  >( coord_type, coord_dims );
    case Type::UINT32  : return tick1< uint32_t >( coord_type, coord_dims );
    case Type::INT32   : return tick1< int32_t  >( coord_type, coord_dims );
    case Type::UINT64  : return tick1< uint64_t >( coord_type, coord_dims );
    case Type::INT64   : return tick1< int64_t  >( coord_type, coord_dims );
    case Type::FLOAT   : return tick1< float    >( coord_type, coord_dims );
    case Type::DOUBLE  : return tick1< double   >( coord_type, coord_dims );
    case Type::STRING  : return tick1< String   >( coord_type, coord_dims );
    case Type::ARRAY   : return tick1< CountPtr< ArrayBase > >( coord_type, coord_dims );
